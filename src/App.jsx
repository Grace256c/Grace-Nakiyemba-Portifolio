      ...
      <nav className="fixed top-0 w-full z-50 bg-surface/70 dark:bg-slate-900/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center max-w-[1200px] mx-auto px-6 md:px-12 py-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center text-white font-bold text-[15px] tracking-tight shadow-sm">
              GN
            </div>
            <span className="font-headline-lg text-headline-lg font-bold tracking-tight text-on-surface dark:text-slate-100">
              Grace Nakiyemba
            </span>
          </div>
